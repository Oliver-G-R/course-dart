main(){
  ...
  */
  ...
  /*
    ...
    de estos strings, agregando dentro de estos mismos los simbolos ${}.
  */
  ...
  */
  ...
  List<String> tasks =  []; // Se declara una lista vacia para su posterior llenado de forma dinamica
  ...
  */
  ...
  passwords.add('oliver123'); // No se puede agregar un elemento repetido, dart lo va a ignorar
  ...
  */
  ...
  Map<String, dynamic> follower2 = new Map(); // segunda forma de declarar un mapa vacio
